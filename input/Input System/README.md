...
**`Unity​Engine.​Input​SystemInput​Action`** \
https://docs.unity3d.com/Packages/com.unity.inputsystem@1.7/api/UnityEngine.InputSystem.InputAction.html?q=InputAction
