...
1. In the SampleScene, select **GameObject** > **UI Toolkit** > **UI Document**. This creates the following:
    -  A UI Toolkit folder with a default **Panel Settings asset** and a **default runtime theme**. (You can change panel asset or use own customed panel asset in panel settings field)
