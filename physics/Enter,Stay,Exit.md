...
- If **at least one of them** have **`Collider.isTrigger` enabled** enabled, no collision detection happens.
- If **both** do not have a **rigidbody**, no collision detection happens.
- 
